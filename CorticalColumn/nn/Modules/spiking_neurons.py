...
from CorticalColumn.behaviours.neurons.specs import KWTA, Fire, InherentNoise, NeuronAxon, NeuronDendrite, SpikeTrace
    ...
    def __init__(
        ...
        if not hasattr(self, "v"):
            if hasattr(self, "v_rest"):
                warnings.warn("Spiking neuron behavior lacks attribute v. Adding the attribute...")
        ...
        if not hasattr(self, "spikes"):
            warnings.warn("Spiking neuron behavior lacks attribute spike. Adding the attribute...")
