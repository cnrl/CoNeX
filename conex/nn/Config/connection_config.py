...
class Pop2LayerConnectionConfig(BaseConfig):
    ...
    exc_learning_rule = None
    exc_learning_params = None
    exc_src_delay_init_mode = None
    exc_src_delay_init_params = None
    exc_dst_delay_init_mode = None
    exc_dst_delay_init_params = None
    exc_w_interval = None
    exc_weight_norm = None
    exc_tag = None
    exc_user_defined_behaviors_class = None
    exc_user_defined_behaviors_params = None
    exc_dst_pop = None

    inh_weight_init_params = {}
    inh_structure = "Simple"
    inh_structure_params = {}
    inh_learning_rule = None
    inh_learning_params = None
    inh_src_delay_init_mode = None
    inh_src_delay_init_params = None
    inh_dst_delay_init_mode = None
    inh_dst_delay_init_params = None
    inh_w_interval = None
    inh_weight_norm = None
    inh_tag = None
    ...
    def make(self):
        ...
        if self.exc_weight_init_params:
            config["pop_exc"] = self._syn_config(
                self.exc_weight_init_params,
                self.exc_structure,
                self.exc_structure_params,
                self.exc_learning_rule,
                self.exc_learning_params,
                self.exc_src_delay_init_mode,
                self.exc_src_delay_init_params,
                self.exc_dst_delay_init_mode,
                self.exc_dst_delay_init_params,
                self.exc_w_interval,
                self.exc_weight_norm,
                self.exc_tag,
        ...
        if self.inh_weight_init_params:
            config["pop_inh"] = self._syn_config(
                self.inh_weight_init_params,
                self.inh_structure,
                self.inh_structure_params,
                self.inh_learning_rule,
                self.inh_learning_params,
                self.inh_src_delay_init_mode,
                self.inh_src_delay_init_params,
                self.inh_dst_delay_init_mode,
                self.inh_dst_delay_init_params,
                self.inh_w_interval,
                self.inh_weight_norm,
                self.inh_tag,
